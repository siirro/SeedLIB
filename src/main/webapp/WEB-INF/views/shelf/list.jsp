	                        	...
	                        	<div class="loanList">
	                                ...
	                                <div class="listTable">
		                                <table class="listTable-t">
		                                    ...
		                                    <tbody>
		                                      	<c:forEach items="${li}" var="sh">
		                                        	<tr>
	                                        			<td><a href="bookList?shNum=${sh.shNum}">${sh.shName}</a></td>
	                                        			<td>${sh.shMemo}</td>
	                                        			<td>${sh.creDate}</td>
	                                        			<td>
		                                        		...
		                                        		<c:if test="${sh} == null">
		                                                	<td class="message footable-last-column footable-first-column" colspan="11">책꽂이가 없습니다.</td>
		                                        		</c:if>
		                                         	</tr>
			                                	</c:forEach>
		                                    </tbody>
