...
<body>
	...
	<div class="contentsGroup">
        ...
        <div class="shelf-con">
        	...
        	<div class="btnArea">
				<button type="button" class="btn white small bbba" id="RealShelfBtn" title="저장">저장</button>
				<a href="javascript:window.close();" class="btn white small bbbb" title="닫기">닫기</a>
			</div>
		</div>
    </div>
