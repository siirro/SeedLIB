...
<div class="innerBox">
<div class="desc" style="width: 80%; margin-left: auto;margin-right: auto;display: flex;align-items: flex-end;justify-content: center;padding: 10px 0;border: thick double #32a1ce;">
